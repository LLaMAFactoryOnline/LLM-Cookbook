...
<div align="center">
  ...
  <p><em>从零掌握大模型微调核心技术，手把手实现专业级模型定制（Powered by LlamaFactory Online）</em></p>
</div>
...
| 章节序号 | 章节标题                          | 核心内容              | 状态 |
|----------|-----------------------------------|--------------------------------|------|
| 第一章   | [NLP详解](./docs/chapter1/1.%20NLP是什么.md)  | 讲解NLP的基础概念、技术演进和核心任务。| ✅    |
| 第二章   | [Transformer架构](./docs/chapter2/1.%20Transformer的历史意义与技术革命.md)| 解析注意力机制，搭建完整Transformer模型。| ✅    |
| 第三章   | [预训练语言模型](./docs/chapter3/1.%20预训练语言模型的革命性意义.md) | 介绍三类预训练语言模型的架构与选型指南。| ✅    |
| 第四章   | [大语言模型](./docs/chapter4/1.%20大语言模型的时代意义.md)| 解读大语言模型的定义与训练方法。| ✅    |
| 第五章   | [大模型微调](./docs/chapter5/1.%20大模型微调的必要性与价值.md) | 讲解SFT、LoRA等主流微调技术，提供实战指南与避坑方案。| ✅  |
| 第六章   | [微调与其他模型优化方案的区别](./docs/chapter6/1.%20理解模型优化的全景图.md)| 对比微调与提示工程、蒸馏、预训练的差异，给出决策框架。| ✅   |
| 第七章   | [主流大模型微调框架与工具栈](./docs/chapter7/1.%20构建高效微调生态系统.md)| 介绍PEFT等微调工具，以及数据处理、硬件优化等配套方案。| ✅    |
| 第八章   | [数据集构建与处理](./docs/chapter8/1.%20数据质量决定模型上限.md)| 讲解数据集构建原则与预处理流程。| ✅    |
| 第九章   | [微调参数详解](./docs/chapter9/1.%20超参数的艺术与科学.md) | 解析学习率、Batch Size等超参数的调优技巧与速查表。| ✅    |
| 第十章   | [LlamaFactory Online](./docs/chapter10/产品简介.md)| 介绍云端微调平台的注册、使用与免费体验。| ✅    |
| 第十一章 | [最佳实践](./docs/chapter11/最佳实践.md) | 展示医疗、法律、金融领域的大模型微调落地案例。| 🛠️    |
...
平台内置海量AI模型，用户只需点击[模型列表](./Extra-Chapter/modelList.md)可查看并获取所有模型，无需逐一手动搜索。以下是平台最新推出的代表性模型示例：Qwen3、InternVL3、Qwen3-VL 等。模型普遍具备以下前沿技术特性：
...
平台内置海量AI模型，这些数据集共同构成了从基础预训练到高级任务微调的完整数据生态，支持多语言、多模态大语言模型的开发与训练，点击[数据集列表](./Extra-Chapter/datasetlList.md)免费获取更多高质量数据集。
...
2. **系统实践**：使用 LlamaFactory Online 完成端到端项目
