...
| 章节序号 | 章节标题                          | 核心内容              | 状态 |
|----------|-----------------------------------|--------------------------------|------|
| 第一章   | NLP详解                          | 讲解NLP的基础概念、技术演进和核心任务。| ✅    |
| 第二章   | Transformer 架构                  | 解析注意力机制，搭建完整Transformer模型。| ✅    |
| 第三章   | 预训练语言模型                   | 介绍三类预训练语言模型的架构与选型指南。| ✅    |
| 第四章   | 大语言模型                       | 解读大语言模型的定义与训练方法。| ✅    |
| 第五章   | 大模型微调                       | 讲解SFT、LoRA等主流微调技术，提供实战指南与避坑方案。| ✅  |
| 第六章   | 微调与其他模型优化方案的区别     | 对比微调与提示工程、蒸馏、预训练的差异，给出决策框架。| ✅   |
| 第七章   | 主流大模型微调框架与工具栈       | 介绍PEFT等微调工具，以及数据处理、硬件优化等配套方案。| ✅    |
| 第八章   | 数据集构建与处理                 | 讲解数据集构建原则与预处理流程。| ✅    |
| 第九章   | 微调参数详解                     | 解析学习率、Batch Size等超参数的调优技巧与速查表。| ✅    |
| 第十章   | LLaMA-Factory Online             | 介绍云端微调平台的注册、使用与免费体验。| ✅    |
| 第十一章 | 最佳实践                         | 展示医疗、法律、金融领域的大模型微调落地案例。| 🛠️    |
