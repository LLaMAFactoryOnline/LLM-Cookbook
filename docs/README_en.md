...
🛠️ **Comprehensive Practical Skills**
...
# 📚 LLM Fine-Tuning Learning Roadmap（with Status）
...
| Llama-4-Scout-17B-16E-Instruct | Multi-sensory Input | /shared-only/models/meta-llama/Llama-4-Scout-17B-16E-Instruct | Meta | Meta’s latest multimodal |
...
## 📊 Industry-Specific Dataset Repository

The platform hosts an extensive collection of AI datasets. These datasets constitute a complete data ecosystem spanning from foundational pre-training to advanced task fine-tuning, supporting multilingual and multimodal LLM development and training. Click [Dataset List](/Extra-Chapter/datasetlList) to access more high-quality datasets for free.

**Pre-training** Datasets: Including wikipedia_zh, wikipedia_en, refinedweb, and redpajama_v2—massive, general-purpose corpora serving as the foundation for models to acquire language and world knowledge.
...
### Target Audience
- 🤖 **AI Engineers/Algorithm Engineers**: Seeking systematic mastery of LLM fine-tuning techniques
- 🎓 **Students/Researchers**: Requiring theoretical foundations and experimental guidance
- 🏢 **Enterprise Technical Leaders**: Pursuing LLM implementation solutions
- 💻 **Developers/Enthusiasts**: Interested in AI and eager to participate in open-source projects

### Recommended Learning Paths

#### Beginner Path（2-3 weeks recommended）
...
1. **Theory Meets Practice**: Each technical concept includes code examples—hands-on execution recommended
...
- Provide detailed descriptions and reproduction steps—we’ll address them promptly.

### 💡 Suggest Improvements
- Have great ideas or feature suggestions? We’d love to hear them
...
- **Project Initiator**：LLM-Cookbook Team
...
### Official Platforms
- 🌐 **Official Website**: https://www.llamafactory.online/
- 💬 **Online Documentation**: https://docs.llamafactory.online/
- 🎥 **Video Tutorials**: https://space.bilibili.com/3546954208381522/upload/video
- 💬 **WeChat Community**: (Scan QR code to add assistant, note “Fine-tuning Guide”)
